...
enum llm_kv {
    ...
    LLM_KV_MTP_HIDDEN_SIZE,
    LLM_KV_MTP_INTERMEDIATE_SIZE,
    LLM_KV_MTP_N_HEAD,
    LLM_KV_MTP_N_HEAD_KV,
    LLM_KV_MTP_GLOBAL_N_HEAD_KV,
    LLM_KV_MTP_HEAD_DIM,
    LLM_KV_MTP_GLOBAL_HEAD_DIM,
    LLM_KV_MTP_SLIDING_WINDOW,
    LLM_KV_MTP_LAYER_NORM_EPS,
    LLM_KV_MTP_LAYER_TYPES,
    LLM_KV_MTP_ROPE_FULL_THETA_E6,
    LLM_KV_MTP_ROPE_SLIDING_THETA_E3,
    LLM_KV_MTP_ROPE_FULL_PARTIAL_FACTOR,
...
enum llm_tensor {
    ...
    // Gemma4-style multi-block MTP (separate hidden size, cross-attention)
    LLM_TENSOR_MTP_PRE_PROJ,
    LLM_TENSOR_MTP_POST_PROJ,
    LLM_TENSOR_MTP_NORM,
    LLM_TENSOR_MTP_EMBED_TOKENS,
    LLM_TENSOR_MTP_ATTN_NORM,
    LLM_TENSOR_MTP_ATTN_POST_NORM,
    LLM_TENSOR_MTP_FFN_PRE_NORM,
    LLM_TENSOR_MTP_FFN_POST_NORM,
    LLM_TENSOR_MTP_ATTN_Q,
    LLM_TENSOR_MTP_ATTN_Q_NORM,
    LLM_TENSOR_MTP_ATTN_OUTPUT,
    LLM_TENSOR_MTP_FFN_GATE,
    LLM_TENSOR_MTP_FFN_UP,
    LLM_TENSOR_MTP_FFN_DOWN,
    LLM_TENSOR_MTP_LAYER_SCALAR,
    LLM_TENSOR_MTP_MASKED_EMB_CENTROIDS,
    LLM_TENSOR_MTP_MASKED_EMB_TOKEN_ORDERING,
};
