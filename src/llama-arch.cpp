...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    // Gemma4-style multi-block MTP
    { LLM_KV_MTP_HIDDEN_SIZE,                   "%s.mtp.hidden_size"                       },
    ...
    { LLM_KV_MTP_LAYER_NORM_EPS,                "%s.mtp.attention.layer_norm_rms_epsilon"  },
    { LLM_KV_MTP_LAYER_TYPES,                   "%s.mtp.layer_types"                       },
    { LLM_KV_MTP_ROPE_FULL_THETA_E6,            "%s.mtp.rope.full.theta_e6"                },
    { LLM_KV_MTP_ROPE_SLIDING_THETA_E3,         "%s.mtp.rope.sliding.theta_e3"             },
    { LLM_KV_MTP_ROPE_FULL_PARTIAL_FACTOR,      "%s.mtp.rope.full.partial_rotary_factor"   },
    { LLM_KV_MTP_USE_ORDERED_EMBEDDINGS,        "%s.mtp.use_ordered_embeddings"            },
    { LLM_KV_MTP_NUM_CENTROIDS,                 "%s.mtp.num_centroids"                     },
    { LLM_KV_MTP_CENTROID_TOP_K,                "%s.mtp.centroid_intermediate_top_k"       },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_MTP_PRE_PROJ,                           "mtp.pre_proj" },
    { LLM_TENSOR_MTP_POST_PROJ,                          "mtp.post_proj" },
    { LLM_TENSOR_MTP_NORM,                               "mtp.norm" },
    { LLM_TENSOR_MTP_EMBED_TOKENS,                       "mtp.embed_tokens" },
    { LLM_TENSOR_MTP_ATTN_NORM,                          "mtp.blk.%d.attn_norm" },
    { LLM_TENSOR_MTP_ATTN_POST_NORM,                     "mtp.blk.%d.attn_post_norm" },
    { LLM_TENSOR_MTP_FFN_PRE_NORM,                       "mtp.blk.%d.ffn_pre_norm" },
    { LLM_TENSOR_MTP_FFN_POST_NORM,                      "mtp.blk.%d.ffn_post_norm" },
    { LLM_TENSOR_MTP_ATTN_Q,                             "mtp.blk.%d.attn_q" },
    { LLM_TENSOR_MTP_ATTN_Q_NORM,                        "mtp.blk.%d.attn_q_norm" },
    { LLM_TENSOR_MTP_ATTN_OUTPUT,                        "mtp.blk.%d.attn_output" },
    { LLM_TENSOR_MTP_FFN_GATE,                           "mtp.blk.%d.ffn_gate" },
    { LLM_TENSOR_MTP_FFN_UP,                             "mtp.blk.%d.ffn_up" },
    { LLM_TENSOR_MTP_FFN_DOWN,                           "mtp.blk.%d.ffn_down" },
    { LLM_TENSOR_MTP_LAYER_SCALAR,                       "mtp.blk.%d.layer_scalar" },
    { LLM_TENSOR_MTP_MASKED_EMB_CENTROIDS,               "mtp.masked_emb_centroids" },
    { LLM_TENSOR_MTP_MASKED_EMB_TOKEN_ORDERING,          "mtp.masked_emb_token_ordering" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // Gemma4-style multi-block MTP overlay
    {LLM_TENSOR_MTP_PRE_PROJ,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_POST_PROJ,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_NORM,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_EMBED_TOKENS,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}}, // tied lm_head: used as MUL_MAT, not GET_ROWS
    {LLM_TENSOR_MTP_ATTN_NORM,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_ATTN_POST_NORM,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_FFN_PRE_NORM,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_FFN_POST_NORM,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_ATTN_Q,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_ATTN_Q_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_ATTN_OUTPUT,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_GATE,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_UP,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_FFN_DOWN,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_LAYER_SCALAR,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_MTP_MASKED_EMB_CENTROIDS,      {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_MTP_MASKED_EMB_TOKEN_ORDERING, {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_GET_ROWS}},
    // Nemotron 3 Super
